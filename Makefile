...
.PHONY: createdb dropdb migrateup migratedown sqlc test server migrateupone migratedownone createPgContainer startPgContainer db_docs createApiAndDbContainers deleteApiAndDbContainers migrateupaws migratedownaws migrateup1 migratedown1 proto evans